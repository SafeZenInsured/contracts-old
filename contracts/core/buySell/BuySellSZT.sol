...
contract BuySellSZT is Ownable, IBuySellSZT, Pausable {
    uint256 public constant SZT_BASE_PRICE = 100;  // SZT token base price
    uint256 public constant SZT_BASE_PRICE_WITH_DEC = 100 * 1e18; // SZT token base price with decimals
    ...
    constructor(uint value, uint decimals, address _DAIaddress) {
